  ...
  public Object getAsObject(FacesContext context, UIComponent component, String value) {
    ...
    if (value != null && value.length() > 0) {
      try {
        ...
        throw new ConverterException(new FacesMessage("Dato no es correcto.", e.getMessage()));
      } catch (Exception e) {
        throw new ConverterException(new FacesMessage("Dato no es correcto.", "La nota debe ser un valor entero."));
      }
    } else {
